...
{
    public class OAuthAuthorizeReadTunnel : ReadWithArgTunnel<OAuthAuthorizeReadTunnel.OAuthResponse,
        OAuthAuthorizeReadTunnel.OAuthRequest>
    {
        ...
        protected override Task<IEnumerable<OAuthResponse>> ReadAllImpl(CancellationToken cancellationToken,
            OAuthRequest request)
        {
            throw new NotImplementedException();
        }

        protected override Task<IEnumerable<OAuthResponse>> ReadPagedImpl(CancellationToken cancellationToken,
            PageInfo pageInfo, OAuthRequest request)
        {
            throw new NotImplementedException();
        }

        protected override Task<IEnumerable<OAuthResponse>> ReadSpecificImpl(CancellationToken cancellationToken,
            OAuthRequest request, Func<IEnumerable<OAuthResponse>, IEnumerable<OAuthResponse>> filter)
        {
            throw new NotImplementedException();
        }
    }
